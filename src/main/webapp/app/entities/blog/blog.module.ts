...
import { OnlineShopAdminModule } from 'app/admin/admin.module';
import {
    BlogComponent,
    BlogDetailComponent,
    BlogUpdateComponent,
...
@NgModule({
    imports: [OnlineShopSharedModule, OnlineShopAdminModule, RouterModule.forChild(ENTITY_STATES)],
...
export class OnlineShopBlogModule {}
